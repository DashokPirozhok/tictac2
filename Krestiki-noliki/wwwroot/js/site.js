...
$(document).ready(function () {
    ...
    function doStep() {
        ...
        $.get('Home/GetInfo/', { a1: a1, a2: a2, a3: a3, b1: b1, b2: b2, b3: b3, c1: c1, c2: c2, c3: c3 }, function (data) {
            ...
            if (data[9] != undefined) {
                if (data[9] == "Win X") {
                    setTimeout(function () { $(".winner").html("<h2>Krestiki wins</h2> ") }, 400);
                }
                else if (data[9] == "Win O") {
                    setTimeout(function () { $(".winner").html("<h2>Noliki wins</h2> ") }, 400);
                }
                else setTimeout(function () { $(".winner").html("<h2>Dead heat</h2>") }, 400);
            }

            if (data[9] == "Win X" || data[9] == "Win O") {
